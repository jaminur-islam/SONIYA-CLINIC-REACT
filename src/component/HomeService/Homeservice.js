  ...
  return (
    <div className='container'>
      <div className='text-center'> 
        ...
        <p className='text-uppercase fw-bold '> We provide some home services, you can pick up later if you need </p>
        </div>
                   ...
                   return (
                    <div className="col-lg-6 col-md-6 text-center col-12">
                      <div className='m-3 p-3 border rounded'>     
                          <img width='100%' className='rounded' height='300' src={care.img} alt="" />
